...
```mermaid
graph TD
    %% Custom Stylings for Glow Aesthetics
    classDef verified fill:#072b22,stroke:#10b981,stroke-width:2px,color:#d1fae5;
    ...
    next_generation_beta_decay_endpoint_spectrometry["Next-Generation Beta Decay Endpoint Spectrometry Beyond KATRIN"]:::theoretical
    ...
    experimental_signatures_distinguishing_causal_sets_from_tensor_networks["Experimental Signatures Distinguishing Causal Sets from Tensor Networks"]:::theoretical
    ...
    dark_acoustic_oscillations_and_dissipation_in_dark_sector_models["Dark Acoustic Oscillations and Dissipation in Complex Dark-Sector Models"]:::theoretical
    hydrodynamic_simulations_baryonic_feedback_sfdm_sidm["Hydrodynamic Simulations Disentangling Baryonic Feedback from SFDM and SIDM"]:::theoretical
    ...
    resolving_kerr_vs_alternative_black_hole_degeneracies["Resolving Kerr vs Alternative Black Hole Degeneracies via Next-Gen Probes"]:::theoretical
    ...
    covariant_quantum_measure_construction_in_causal_set_theory["Covariant Quantum Measure Construction in Causal Set Theory"]:::theoretical
    ...
    non_standard_early_cosmologies_and_dark_matter_relic_abundances["Non-Standard Early Cosmologies and Dark Matter Relic Abundances"]:::theoretical
    ...
    relativistic_simulations_differentiating_sfdm_from_lambda_cdm["Relativistic Simulations Differentiating SFDM from Lambda-CDM"]:::theoretical
    ...
    uv_completions_and_experimental_testability_of_bsm_models["Ultraviolet Completions and Experimental Testability of BSM Physics"]:::theoretical
    ...
    experimental_advancements_in_neutrino_decay_constraints["Experimental Advancements in Neutrino Decay Constraints"]:::verified
    operator_theoretic_foundations_of_neutrino_decay["Operator-Theoretic Foundations of Neutrino Decay Survival Probabilities"]:::verified
    ...
    wimp_baryogenesis_models_and_washout_constraints["WIMP Baryogenesis Models and Washout Constraints"]:::theoretical
    noethers_theorem["Noether's Theorem"]:::verified
    five_gev_asymmetric_dark_matter_skipper_ccd_constraints["5 GeV Asymmetric Dark Matter Mass Scale and Skipper-CCD Constraints"]:::theoretical
    ...
    numerical_benchmarks_for_neutrino_decay_in_boltzmann_codes["Numerical Benchmarks for Neutrino Decay in Cosmological Boltzmann Codes"]:::theoretical
    ...
    gravitational_lensing["Gravitational Lensing"]:::verified
    classical_mechanics["Classical Mechanics"]:::verified
    non_hermitian_effective_hamiltonian_neutral_meson_systems["Non-Hermitian Effective Hamiltonian for Neutral-Meson Systems"]:::verified
    ...
    modified_newtonian_dynamics_mond_vs_wimp_dark_matter_in_galaxy_cluster_dynamics["Modified Newtonian Dynamics (MOND) vs WIMP Dark Matter in Galaxy Cluster Dynamics"]:::verified
    ...
    parity_violation_vs_scalar_charge_in_strongfield_gravity["Parity Violation vs Scalar Charge in Strong-Field Gravity"]:::theoretical
    ...
    initial_condition_entropy_and_arrow_of_time["Initial Condition Entropy and Arrow of Time"]:::theoretical
    ...
    conformal_gravity_vs_nfw_dark_matter_models_in_resolving_the_corecusp_problem["Conformal Gravity vs NFW Dark Matter Models in Resolving the Core-Cusp Problem"]:::verified
    ...
    asymptotically_safe_gravity_vs_causal_dynamical_triangulations_in_resolving_ultraviolet_spacetime_singularities["Asymptotically Safe Gravity vs Causal Dynamical Triangulations in Resolving Ultraviolet Spacetime Singularities"]:::theoretical
    ...
    neutrino_oscillations --- distinguishing_higgs_portal_from_sterile_neutrino_dark_matter
    ...
    neutrino_oscillations --- mathematical_formulation_of_neutrino_decay_survival_probabilities
    quantum_decoherence --- mathematical_formulation_of_neutrino_decay_survival_probabilities
    neutrino_oscillations --- neutrino_mass_hierarchies_and_their_implications
    quantum_gravity --- quantum_sequential_growth_process_in_causal_set_cosmology
    ...
    dark_matter --- non_standard_early_cosmologies_and_dark_matter_relic_abundances
    ...
    quantum_mechanics --- experimental_advancements_in_neutrino_decay_constraints
    standard_model_of_particle_physics --- experimental_advancements_in_neutrino_decay_constraints
    quantum_decoherence --- operator_theoretic_foundations_of_neutrino_decay
    dark_matter --- wimp_baryogenesis_models_and_washout_constraints
    quantum_field_theory --- wimp_baryogenesis_models_and_washout_constraints
    neutrino_oscillations --- collaborative_empirical_test_strategies_for_neutrino_models
    ...
    quantum_field_theory --- standard_model_of_particle_physics
    ...
    neutrinoless_double_beta_decay --- bayesian_evidence_analysis_neutrino_decay_hypothesis
    ...
    quantum_field_theory --- quantum_mechanics
    neutrino_oscillations --- distinguishing_neutrino_decay_from_damping_and_decoherence
    standard_model_of_particle_physics --- higher_order_effects_and_non_standard_interactions_in_neutrino_dynamics
    quantum_electrodynamics_qed --- quantum_vacuum_and_spacetime_structure
    dark_matter --- gravitational_lensing
    general_relativity --- gravitational_lensing
    effective_field_theory --- non_hermitian_effective_hamiltonian_neutral_meson_systems
    ...
    effective_field_theory --> asymmetric_dark_matter_vs_wimp_baryogenesis_in_explaining_matterantimatter_asymmetry
    quantum_gravity --> asymptotic_safety_vs_noncommutative_geometry_in_ultraviolet_completion_of_quantum_gravity
    dark_matter --> modified_newtonian_dynamics_mond_vs_wimp_dark_matter_in_galaxy_cluster_dynamics
    general_relativity --> modified_newtonian_dynamics_mond_vs_wimp_dark_matter_in_galaxy_cluster_dynamics
    ...
    effective_field_theory --> symmetryprotected_topological_phases_vs_topological_insulators_in_quantum_gravity
    ...
    effective_field_theory --> asymptotic_safety_vs_noncommutative_geometry_in_ultraviolet_completion_of_spacetime
    ...
    effective_field_theory --> scalartensor_gravity_vs_galileon_gravity_in_addressing_cosmic_acceleration
    quantum_gravity --> asymptotically_safe_gravity_vs_causal_dynamical_triangulations_in_resolving_ultraviolet_spacetime_singularities
    ...
    effective_field_theory --> axionlike_particles_vs_primordial_black_holes_in_explaining_dark_matter_coldness
    ...
    gravitational_lensing --> interacting_dark_matter_vs_selfinteracting_dark_matter_in_resolving_smallscale_structure_challenges
    ...
    gravitational_lensing --> conformal_gravity_vs_cold_dark_matter_in_explaining_galactic_rotation_curves
    ...
    quantum_gravity --> unimodular_gravity_vs_vacuum_energy_sequestering_in_addressing_the_cosmological_constant_problem
...
- [5 GeV Asymmetric Dark Matter Mass Scale and Skipper-CCD Constraints](level_1_fundamental_physics/five_gev_asymmetric_dark_matter_skipper_ccd_constraints.md) [THEORETICAL]
...
- [Dark Acoustic Oscillations and Dissipation in Complex Dark-Sector Models](level_1_fundamental_physics/dark_acoustic_oscillations_and_dissipation_in_dark_sector_models.md) [THEORETICAL]
- [Dark Matter](level_1_fundamental_physics/dark_matter.md) [THEORETICAL]
- [Dimensional Analysis and Unit Tracing of Modified Survival Equations](level_1_fundamental_physics/dimensional_analysis_and_unit_tracing_of_modified_survival_equations.md) [THEORETICAL]
- [Direct Detection Strategies for Neutrino Decay](level_1_fundamental_physics/direct_detection_strategies_for_neutrino_decay.md) [THEORETICAL]
- [Discriminating Warm vs Cold Dark Matter via Cosmological Probes](level_1_fundamental_physics/discriminating_warm_vs_cold_dark_matter_via_cosmological_probes.md) [THEORETICAL]
- [Disentangling Neutrino Decay from NSI and Environmental Decoherence](level_1_fundamental_physics/disentangling_neutrino_decay_from_nsi_and_decoherence.md) [THEORETICAL]
- [Disentangling Neutrino Invisible Decay from Flux Normalization Errors](level_1_fundamental_physics/disentangling_neutrino_invisible_decay_from_flux_normalization_errors.md) [THEORETICAL]
- [Distinguishing Freeze-In and Freeze-Out Dark Matter Mechanisms](level_1_fundamental_physics/distinguishing_freeze_in_and_freeze_out_dark_matter_mechanisms.md) [THEORETICAL]
- [Distinguishing Higgs Portal from Sterile Neutrino Dark Matter](level_1_fundamental_physics/distinguishing_higgs_portal_from_sterile_neutrino_dark_matter.md) [THEORETICAL]
...
- [Experimental Advancements in Neutrino Decay Constraints](level_1_fundamental_physics/experimental_advancements_in_neutrino_decay_constraints.md) [VERIFIED]
- [Experimental Collaboration Bounds on Neutrino Decay](level_1_fundamental_physics/experimental_collaboration_bounds_on_neutrino_decay.md) [VERIFIED]
...
- [Integrating Higher-Order Effects and Non-Standard Interactions in Neutrino Dynamics](level_1_fundamental_physics/higher_order_effects_and_non_standard_interactions_in_neutrino_dynamics.md) [THEORETICAL]
- [Joint Bayesian Evidence Analysis of the Neutrino Decay Hypothesis](level_1_fundamental_physics/bayesian_evidence_analysis_neutrino_decay_hypothesis.md) [THEORETICAL]
- [Laboratory Haloscope and Light-Mediator Tests of SIDM and SFDM](level_1_fundamental_physics/laboratory_tests_of_sidm_and_sfdm_variants.md) [THEORETICAL]
- [Low-Mass Axion Dark Matter Detection Strategies](level_1_fundamental_physics/low_mass_axion_dark_matter_detection_strategies.md) [VERIFIED]
- [Mathematical Formulation of Neutrino Decay Survival Probabilities](level_1_fundamental_physics/mathematical_formulation_of_neutrino_decay_survival_probabilities.md) [THEORETICAL]
...
- [Minimum Viable Modifications to General Relativity](level_1_fundamental_physics/minimum_viable_modifications_to_general_relativity.md) [THEORETICAL]
- [Modified Neutrino Survival Probabilities and Vacuum Decoherence](level_1_fundamental_physics/modified_neutrino_survival_probabilities_and_vacuum_decoherence.md) [THEORETICAL]
...
- [Neutrino Decay Lifetime Limits and Systematic Uncertainties](level_1_fundamental_physics/neutrino_decay_lifetime_limits_and_systematic_uncertainties.md) [THEORETICAL]
- [Neutrino Decay Width Constraints and Decay-Inclusive Oscillations](level_1_fundamental_physics/neutrino_decay_width_constraints_and_decay_inclusive_oscillations.md) [THEORETICAL]
...
- [Neutrino Masses and Leptogenesis](level_1_fundamental_physics/neutrino_masses_and_leptogenesis.md) [VERIFIED]
...
- [Non-Standard Interactions and Neutrino Decay Lifetime Bounds at DUNE](level_1_fundamental_physics/non_standard_interactions_and_neutrino_decay_lifetime_bounds_at_dune.md) [VERIFIED]
- [Numerical Benchmarks for Neutrino Decay in Cosmological Boltzmann Codes](level_1_fundamental_physics/numerical_benchmarks_for_neutrino_decay_in_boltzmann_codes.md) [THEORETICAL]
...
- [Reducing Nuclear Matrix Element Uncertainties in 0vbb Decay](level_1_fundamental_physics/reducing_nuclear_matrix_element_uncertainties_in_0vbb_decay.md) [THEORETICAL]
- [Refining Cosmological Observations for Neutrino Decay Signatures](level_1_fundamental_physics/refining_cosmological_observations_for_neutrino_decay_signatures.md) [THEORETICAL]
- [Relativistic Simulations Differentiating SFDM from Lambda-CDM](level_1_fundamental_physics/relativistic_simulations_differentiating_sfdm_from_lambda_cdm.md) [THEORETICAL]
- [Renormalization and the Renormalization Group](level_1_fundamental_physics/renormalization_and_the_renormalization_group.md) [VERIFIED]
- [Resolving Kerr vs Alternative Black Hole Degeneracies via Next-Gen Probes](level_1_fundamental_physics/resolving_kerr_vs_alternative_black_hole_degeneracies.md) [THEORETICAL]
...
- [Asymptotically Safe Gravity vs Causal Dynamical Triangulations in Resolving Ultraviolet Spacetime Singularities](level_2_advanced_frameworks/asymptotically_safe_gravity_vs_causal_dynamical_triangulations_in_resolving_ultraviolet_spacetime_singularities.md) [THEORETICAL]
...
- [f(T) Gravity vs. K-Essence in Addressing Cosmic Acceleration](level_2_advanced_frameworks/ft_gravity_vs_kessence_in_addressing_cosmic_acceleration.md) [THEORETICAL]
...
- [Modified Newtonian Dynamics (MOND) vs WIMP Dark Matter in Galaxy Cluster Dynamics](level_2_advanced_frameworks/modified_newtonian_dynamics_mond_vs_wimp_dark_matter_in_galaxy_cluster_dynamics.md) [VERIFIED]
...
- [Randall-Sundrum vs. ADD Models in Hierarchy Problem Resolution: Comparative Analysis of Phenomenological Signatures](level_2_advanced_frameworks/randallsundrum_vs_add_models_in_hierarchy_problem_resolution_comparative_analysis_of_phenomenological_signatures.md) [THEORETICAL]
...
- [SU(5) vs SO(10) Grand Unification: Fermion Masses and Proton Decay](level_2_advanced_frameworks/su5_vs_so10_grand_unification_fermion_masses_and_proton_decay.md) [VERIFIED]
...
- [Operational Criteria for Cosmic Computation: A Falsifiable Energy-Latency-Error Benchmark Comparing Cosmic-Web Self-Organization with Biological Neural Information Processing](level_3_emergence_and_intelligence/operational_criteria_for_cosmic_computation_a_falsifiable_energylatencyerror_benchmark_comparing_cosmicweb_selforganization_with_biological_neural_information_processing.md) [THEORETICAL]
