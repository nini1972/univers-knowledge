...
graph TD
    ...
    what_specific_experimental_signature_could_unambiguously_differentiate_a_screeningprotected_scalar_field_from_a_nonlocal_interaction_in_the_context_of_strongfield_gravity_eg_binary_black_hole_mergers["What specific experimental signature could unambiguously differentiate a screening-protected scalar field from a non-local interaction in the context of strong-field gravity (e.g., binary black hole mergers)?"]:::theoretical
    ...
    how_can_hydrodynamic_simulations_be_structured_to_conclusively_break_the_degeneracy_between_baryonic_feedback_effects_and_darksector_physics_sfdm_wave_effects_vs_sidm_collisions_in_dwarf_galaxy_cores["How can hydrodynamic simulations be structured to conclusively break the degeneracy between baryonic feedback effects and dark-sector physics (SFDM wave effects vs. SIDM collisions) in dwarf galaxy cores?"]:::theoretical
    ...
    what_specific_laboratorybased_experiment_such_as_an_axion_haloscope_or_lightmediator_search_could_definitively_falsify_the_most_plausible_variants_of_sidm_or_sfdm["What specific laboratory-based experiment, such as an axion haloscope or light-mediator search, could definitively falsify the most plausible variants of SIDM or SFDM?"]:::theoretical
    ...
    how_can_the_proposed_comparison_between_nearby_steady_astrophysical_sources_and_the_diffuse_neutrino_population_be_statistically_quantified_to_yield_an_unambiguous_test_given_that["How can the proposed comparison between nearby steady astrophysical sources and the diffuse neutrino population be statistically quantified to yield an unambiguous test, given that the current statistics for nearby neutrino sources like NGC 1068 remain low?"]:::theoretical
    ...
    how_would_a_joint_bayesian_evidence_analysis_significantly_alter_the_current_frequentist_conclusion_that_the_decay_hypothesis_is_only_a_15_fluctuation["How would a joint Bayesian evidence analysis significantly alter the current frequentist conclusion that the 'decay hypothesis' is only a 1.5σ fluctuation?"]:::theoretical
    ...
    to_what_degree_do_current_uncertainties_in_dunes_nuclear_crossmodel_backgrounds_eg_rpa_2p2h_effects_overlap_with_the_energydependent_spectral_distortion_predicted_by_visible_neutrino_decay["The degeneracy between DUNE's nuclear cross-section modeling uncertainties and visible neutrino decay"]:::theoretical
    ...
    does_the_inclusion_of_potential_nonstandard_interactions_nsi_in_the_matterevolution_hamiltonian_qualitatively_shift_the_existing_bounds_on_neutrino_decay_lifetimes_at_dune["Does the inclusion of potential Non-Standard Interactions (NSI) in the matter-evolution Hamiltonian qualitatively shift the existing bounds on neutrino decay lifetimes at DUNE?"]:::verified
    can_rigorous_manual_dimensional_consistency_checks_be_performed_by_experts_to_supplement_the_automated_undecidable_result["Can rigorous manual dimensional consistency checks be performed by experts to supplement the automated undecidable result?"]:::verified
    ...
    are_there_experimental_strategies_to_better_constrain_neutrino_decay_widths_j_and_confirm_decayinclusive_oscillation_modifications["Are there experimental strategies to better constrain neutrino decay widths Γ_j and confirm decay-inclusive oscillation modifications?"]:::theoretical
    ...
    what_progress_has_been_made_in_extending_tensor_network_methods_to_fully_dynamical_lorentzian_spacetimes_reproducing_classical_gravity["What progress has been made in extending tensor network methods to fully dynamical Lorentzian spacetimes reproducing classical gravity?"]:::theoretical
    ...
    quantum_decoherence --- can_you_provide_a_rigorous_derivationbased_proof_of_the_modified_survival_probability_equations_using_nonhermitian_hamiltonians_and_lindblad_operator_formalism
    ...
    standard_model_of_particle_physics --- what_steps_can_be_taken_to_integrate_higherorder_effects_and_nonstandard_interactions_consistently_within_the_existing_framework
    ...
    neutrinoless_double_beta_decay --- how_would_a_joint_bayesian_evidence_analysis_significantly_alter_the_current_frequentist_conclusion_that_the_decay_hypothesis_is_only_a_15_fluctuation
    neutrino_oscillation_mechanisms --- to_what_degree_do_current_uncertainties_in_dunes_nuclear_crossmodel_backgrounds_eg_rpa_2p2h_effects_overlap_with_the_energydependent_spectral_distortion_predicted_by_visible_neutrino_decay
    ...
    neutrino_oscillations --- are_there_experimental_strategies_to_better_constrain_neutrino_decay_widths_j_and_confirm_decayinclusive_oscillation_modifications
    neutrino_oscillations --- what_experimental_designs_or_data_analyses_can_definitively_distinguish_neutrino_decay_effects_from_alternative_damping_mechanisms_such_as_decoherence_or_nonstandard_interactions
    ...
    quantum_gravity --- what_progress_has_been_made_in_extending_tensor_network_methods_to_fully_dynamical_lorentzian_spacetimes_reproducing_classical_gravity
...
- [Does the inclusion of potential Non-Standard Interactions (NSI) in the matter-evolution Hamiltonian qualitatively shift the existing bounds on neutrino decay lifetimes at DUNE?](level_1_fundamental_physics/does_the_inclusion_of_potential_nonstandard_interactions_nsi_in_the_matterevolution_hamiltonian_qualitatively_shift_the_existing_bounds_on_neutrino_decay_lifetimes_at_dune.md) [VERIFIED]
...
- [How can hydrodynamic simulations be structured to conclusively break the degeneracy between baryonic feedback effects and dark-sector physics (SFDM wave effects vs. SIDM collisions) in dwarf galaxy cores?](level_1_fundamental_physics/how_can_hydrodynamic_simulations_be_structured_to_conclusively_break_the_degeneracy_between_baryonic_feedback_effects_and_darksector_physics_sfdm_wave_effects_vs_sidm_collisions_in_dwarf_galaxy_cores.md) [THEORETICAL]
...
- [How can the proposed comparison between nearby steady astrophysical sources and the diffuse neutrino population be statistically quantified to yield an unambiguous test, given that the current statistics for nearby neutrino sources like NGC 1068 remain low?](level_1_fundamental_physics/how_can_the_proposed_comparison_between_nearby_steady_astrophysical_sources_and_the_diffuse_neutrino_population_be_statistically_quantified_to_yield_an_unambiguous_test_given_that.md) [THEORETICAL]
...
- [How would a joint Bayesian evidence analysis significantly alter the current frequentist conclusion that the 'decay hypothesis' is only a 1.5σ fluctuation?](level_1_fundamental_physics/how_would_a_joint_bayesian_evidence_analysis_significantly_alter_the_current_frequentist_conclusion_that_the_decay_hypothesis_is_only_a_15_fluctuation.md) [THEORETICAL]
...
- [Integrating Higher-Order Effects and Non-Standard Interactions Consistently Within the Existing Framework](level_1_fundamental_physics/what_steps_can_be_taken_to_integrate_higherorder_effects_and_nonstandard_interactions_consistently_within_the_existing_framework.md) [THEORETICAL]
...
- [Neutrino Decay](level_1_fundamental_physics/what_advancements_or_new_data_from_upcoming_experiments_could_improve_the_mathematical_modeling_and_strengthen_the_formalism_of_neutrino_decay_constraints.md) [VERIFIED]
- [Neutrino Decay Lifetime Limits](level_1_fundamental_physics/can_a_detailed_quantitative_breakdown_of_systematic_uncertainties_in_neutrino_decay_lifetime_measurements_be_provided_for_each_major_experimental_collaboration.md) [THEORETICAL]
...
- [What experimental designs or data analyses can definitively distinguish neutrino decay effects from alternative damping mechanisms such as decoherence or non-standard interactions?](level_1_fundamental_physics/what_experimental_designs_or_data_analyses_can_definitively_distinguish_neutrino_decay_effects_from_alternative_damping_mechanisms_such_as_decoherence_or_nonstandard_interactions.md) [THEORETICAL]
...
- [What progress has been made in extending tensor network methods to fully dynamical Lorentzian spacetimes reproducing classical gravity?](level_1_fundamental_physics/what_progress_has_been_made_in_extending_tensor_network_methods_to_fully_dynamical_lorentzian_spacetimes_reproducing_classical_gravity.md) [THEORETICAL]
...
- [What specific laboratory-based experiment, such as an axion haloscope or light-mediator search, could definitively falsify the most plausible variants of SIDM or SFDM?](level_1_fundamental_physics/what_specific_laboratorybased_experiment_such_as_an_axion_haloscope_or_lightmediator_search_could_definitively_falsify_the_most_plausible_variants_of_sidm_or_sfdm.md) [THEORETICAL]
