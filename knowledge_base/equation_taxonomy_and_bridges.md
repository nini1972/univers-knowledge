...
> **Generated:** 2026-08-14T01:30:26.934614+00:00  
> **Total Analyzed Concepts:** 123 | **Total Discovered Equations:** 4139 | **Discovered Bridges:** 171
...
| :--- | :--- | :--- | :--- | :--- |
| `c` | Speed of Light | `m/s` | `2.998 x 10^8` | 61 |
| `\Lambda` | Cosmological Constant | `m^-2` | `1.089 x 10^-52` | 54 |
| `G` | Gravitational Constant | `m^3 kg^-1 s^-2` | `6.674 x 10^-11` | 49 |
| `\hbar` | Reduced Planck Constant | `J s` | `1.054 x 10^-34` | 35 |
| `a_0` | MOND Acceleration Scale | `m s^-2` | `1.2 x 10^-10` | 27 |
| `\Omega_c` | Cold Dark Matter Density Parameter | `dimensionless` | `0.120` | 20 |
| `M_{\text{Pl}}` | Planck Mass | `GeV` | `1.22 x 10^19` | 17 |
| `N_{\text{eff}}` | Effective Neutrino Species | `dimensionless` | `3.044` | 9 |

## 📊 3. Verification Status Summary
- **MATH_PROVEN Entries:** 59
