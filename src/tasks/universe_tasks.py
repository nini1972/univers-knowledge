...
class UniverseTasks:
    ...
    def document_knowledge_task(self, agent, output_path, include_visual=True, approved_summary=None, math_status=None, math_score=None, math_report=None):
        ...
        visual_source = "and the generated image tag or [VISUAL_PENDING: ...] placeholder from the Visualizer"
        visual_insert = "and INSERT the Markdown image tag or the [VISUAL_PENDING: ...] placeholder generated by the Visualizer directly into section '## 5. Visual Representation' (or '## 6. Visual Representation' depending on the template layout) instead of using a fake or template URL."
